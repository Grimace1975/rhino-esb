...
{
    public class UsingFilesBusWithAlternateStorageLocation : WithDebugging, IDisposable
    {
        ...
        public UsingFilesBusWithAlternateStorageLocation()
        {
            ...
            var hostConfiguration = new HostConfiguration()
                .AddAssembly(typeof(FilesTransport).Assembly)
                .StoragePath(alternateStorageLocation)
                .Bus("file.null://localhost/test_queue2", "test")
                .Receive("Rhino.ServiceBus.Tests", "file.null://localhost/test_queue");
