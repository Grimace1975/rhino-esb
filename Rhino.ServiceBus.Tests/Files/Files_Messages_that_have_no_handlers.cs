...
{
	public class Files_Messages_that_have_no_handlers : WithDebugging
    {
		public Files_Messages_that_have_no_handlers()
        {
		...
		private static IWindsorContainer CreateContainer()
		{
            ...
            new RhinoServiceBusConfiguration()
                ...
                .UseStandaloneConfigurationFile("Files/Files.config")
                .Configure();
			return container;
		}
        ...
        public void Should_go_to_discard_sub_queue_and_be_able_to_restart_bus()
        {
            ...
            using (var bus = container.Resolve<IStartableServiceBus>())
            {
				...
				var transport = (FilesTransport)container.Resolve<ITransport>();
