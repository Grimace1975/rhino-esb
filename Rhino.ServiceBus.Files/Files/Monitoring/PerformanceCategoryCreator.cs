...
namespace Rhino.ServiceBus.Files.Monitoring
{
    public static class PerformanceCategoryCreator
    {
        ...
        public static void CreateCategories()
        {
            ...
            catch (UnauthorizedAccessException ex) { logger.Error("Not authorized to create performance counters. User must be an administrator to perform this action.", ex); throw; }
        }
        ...
        private static void CreateOutboundCategory()
        {
            ...
            catch (Exception ex) { logger.Error("Creation of outbound counters failed.", ex); throw; }
        }
        ...
        private static void CreateInboundCategory()
        {
            ...
            catch (Exception ex) { logger.Error("Creation of inbound counters failed.", ex); throw; }
        }
    }
}